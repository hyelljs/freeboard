...
<body>
<!-- top.jsp에 작성된 코드 가 포함됩니다. 포함 후에 서블릿 변환 및 컴파일 됩니다. -->
<%@ include file="top.jsp" %>
<!-- 아래의 section 태그 내용은 웹사이트 초기호면으로 이미지, 주요 홍보 영상, Quick Link, 주요 게시물
	  포함하도록 수정합니다. -->
<section>
...
<c:if test="${sessionScope.readIdx==null}">	
	...
	<!-- <a href="./login.do">로그인</a> -->	<!-- 현재 freeboard에서 login.do -->
